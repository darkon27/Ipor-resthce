...
namespace RoyalSISWS.Models.SpringSalud_produccion
{
    ...
    public partial class PersonaMast
    {
        ...
        public Nullable<int> idpersona_ok { get; set; }
        ...
        public string Estado_BK { get; set; }
        public string Estado_Bks { get; set; }
        ...
        public Nullable<int> IndicadorUnificado { get; set; }
        public Nullable<System.DateTime> FEC_MOD_TRIGGER { get; set; }
        ...
        public Nullable<int> SituacionDuplicado { get; set; }
        public Nullable<System.DateTime> FechaUnificacion { get; set; }
        public string UsuarioUnificacion { get; set; }
        public string ValidadoOUHC { get; set; }
        public string FuenteOUHC { get; set; }
        public string UsuarioOUHC { get; set; }
        public Nullable<System.DateTime> FechaOUHC { get; set; }
        public string CorreoFacturacionElectronica { get; set; }
        public string TipoDocumentoMedicoTrama { get; set; }
        public string DocumentoMedicoTrama { get; set; }
        public string AseguradoraNombreONBASE { get; set; }
        public string CodigoEstablecimiento { get; set; }
        public Nullable<decimal> LatitudGeografica { get; set; }
        public Nullable<decimal> LongitudGeografica { get; set; }
